...
public class Main_Placeholder extends Fragment {
	...
	public static Main_Placeholder newInstance(Context parentcontext) {

		myContext=parentcontext;
		mydevicelog= new Devicelog(myContext);

		Main_Placeholder fragment = new Main_Placeholder();
