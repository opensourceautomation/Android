...
public class Main_Log extends ListFragment {
	...
	public static Main_Log newInstance(Context parentcontext) {

		myContext=parentcontext;
		mydevicelog= new Devicelog(myContext);

		Main_Log fragment = new Main_Log();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.mainlist, container, false);		
        ...
        if (myContext != null) {
        	...
        	initializeDB();
        	myContext.registerReceiver(mHandleMessageReceiver, new IntentFilter(REFRESH_LOG_ACTION));
        }
    ...
    private Boolean getNotifications(Date lastDate){
        ...
        String query="SELECT _id, osaid, message, category, level, deleted, notifydate, notification, alert, speech, toast, popup, vibrate FROM notification_log where notifydate<=? order by notifydate desc LIMIT ?;";
...
//        	EndlessAdapter myadapter =(EndlessAdapter) list.getAdapter();
