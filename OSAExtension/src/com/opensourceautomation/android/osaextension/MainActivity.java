...
public class MainActivity extends Activity 
{
	...
	private void ProcessSpeechResult(Intent data)
	{
		...
		speechList.setOnItemClickListener(new OnItemClickListener()
		{
			...
			{        		
				SendSpeechCommand ssc = new SendSpeechCommand(myContext,speechList.getItemAtPosition(position).toString());
				ssc.execute("");
	...
	protected class SendSpeechCommand extends AsyncTask<String, Void, String> 
	{
		...
		SendSpeechCommand(Context context, String commandToSend) 
		{

			try {
				speechCommand = URLEncoder.encode(commandToSend, "utf-8");
		...
		protected String doInBackground(String... urls) 
		{
			...
			String url;
			url = "http://" + serverIP + ":" + serverPort + "/api/namedscript/" + speechCommand;
			...
			//get rid of extra line so our match below will work
