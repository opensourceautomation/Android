...
import com.opensourceautomation.android.osaextension.R.menu;
 ...
 */
public abstract class AbstractPluginFragmentActivity extends FragmentActivity
{
    /**
    ...
    public void setTitle(String mtitle){
        ...
        {
            setTitle(BreadCrumber.generateBreadcrumb(getApplicationContext(), getIntent(),title));
        }
    }
    
    public void setFinalized(Boolean isFinalized){
    	
    	mIsFinalized = isFinalized;
    ...
    private void setupTitleApi11()
    {
        ...
        catch (final NameNotFoundException e)
        {
            ...
            {
                Log.e(CommonUtilities.LOG_TAG, "Calling package couldn't be found", e); //$NON-NLS-1$
            }
        }
    ...
    {
        getActionBar().setSubtitle(BreadCrumber.generateBreadcrumb(getApplicationContext(), getIntent(),title));
    }
    ...
    private void setupActionBarApi14()
    {
        ...
        catch (final NameNotFoundException e)
        {
            if (CommonUtilities.IS_LOGGABLE)
            {
                Log.w(CommonUtilities.LOG_TAG, "An error occurred loading the host's icon", e); //$NON-NLS-1$
            }
        }
    }
