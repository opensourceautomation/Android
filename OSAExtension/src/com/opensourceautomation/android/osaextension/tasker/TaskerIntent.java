...
public class TaskerIntent extends Intent {
	...
	private final static String TASKER_PREFS_URI = "content://net.dinglisch.android.tasker/prefs";
	...
	// still need to test result after sending intent
	...
	public static Status testStatus( Context c ) {
		...
		else if ( ! TaskerIntent.prefSet( c, "enabled" ) )
			result = Status.NotEnabled;
		else if ( ! TaskerIntent.prefSet( c, "ext_access" ) )
